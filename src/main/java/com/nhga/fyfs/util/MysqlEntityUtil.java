...
public class MysqlEntityUtil {
    ...
    private static final String URL = "jdbc:mysql://60.190.149.52:33060/online_anti_fraud";
    private static final String NAME = "nhga";
    private static final String PASS = "0573@nhga";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private String packageOutPath = "com.model";// 指定实体生成所在包的路径
    private String authorName = "wwq";// 作者名字
