...
public class URLConstant {
     ...
     * 获取审批列表接口
     */
    public static final String URL_APPROVAL_LIST = "https://oapi.dingtalk.com/topapi/processinstance/listids";

    /**
     * 获取审批详情接口url
     */
    public static final String URL_APPROVAL_INFO = "https://oapi.dingtalk.com/topapi/processinstance/get";
}
